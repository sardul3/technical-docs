<template>
  <div class="w-full overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
    <img class="object-cover object-center w-full h-56" :src="profileImage" alt="avatar" />
    ...
    <div class="px-6 py-4">
      ...
      <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
        ...
        <span class="px-2 text-sm">{{ company }}</span>
      </div>
      ...
      <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
        ...
        <span class="px-2 text-sm">{{ location }}</span>
      </div>
      ...
      <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
        ...
        <span class="px-2 text-sm">{{ email }}</span>
      </div>
    </div>
  </div>
</template>
...
export default {
  props: {
    ...
    description: {
      type: String,
      default: "Full Stack engineer with a passion for building scalable and efficient systems.",
    },
    company: {
      type: String,
      default: "Kroger",
    ...
    email: {
      type: String,
      default: "poudelsagar530@gmail.com",
    },
  },
  data() {
    return {
