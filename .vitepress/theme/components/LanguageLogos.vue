<template>
    <div class="flex items-center">
      <img
        class="h-16 w-16 -mx-2.5 ring ring-white dark:ring-gray-900 rounded-full object-cover"
        src="https://upload.wikimedia.org/wikipedia/commons/9/99/Unofficial_JavaScript_logo_2.svg"
        alt="JavaScript"
      />

      <svg viewBox="0 0 128 128" class="h-16 w-16 -mx-2.5 ring ring-white dark:ring-gray-900 rounded-full object-cover">
